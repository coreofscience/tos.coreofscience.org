const About = () => (
  <article className="prose prose-stone m-auto">
    ...
    <p>
      The inception of <strong>Tree of Science</strong> can be traced back to a
      groundbreaking doctoral thesis that explored the diffusion process without
      monetary incentives. This research garnered acclaim and was published in
      the prestigious Journal of Business Research, marking a significant
      milestone in our journey.
    </p>
    <p>
      Since its initial launch, <strong>Tree of Science</strong> has captivated
      the global academic community. Our first version engaged around 11,000
      users and processed over 2 million queries from the Web of Science (WoS),
      showcasing our tool&#39;s broad appeal and utility. The overwhelming
      response led to the formation of Core of Science, with{" "}
    ...
    <p>
      <strong>Tree of Science</strong> is not just a tool; it&#39;s a gateway to
      a world of scientific discovery and analysis. Our platform offers
      ...
      seasoned researchers to academic institutions and research organizations.
    </p>
    <p>
